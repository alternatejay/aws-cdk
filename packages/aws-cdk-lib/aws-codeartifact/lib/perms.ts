 ...
 * @experimental
 */
export const REPOSITORY_WRITE_ACTIONS = ["codeartifact:PublishPackageVersion", "codeartifact:PutPackageMetadata"];
 ...
 * @experimental
 */
export const DOMAIN_CREATE_ACTIONS = ["codeartifact:CreateRepository"];

/**
 * @experimental
 */
export const DOMAIN_LOGIN_ACTIONS = ["codeartifact:GetAuthorizationToken"];
